      ...
      <div class="container">  
        <nav class="flex items-centre justify-between">  
          ...
          <div class="hero flex items-centre justify-between">
            ...
            <h6>Ikhwan Hanif Firdaus</h6>
            <h1>I'm a Web<br> <span>Developer Banteng PDI Perjuangan</span></h1>
            <p>Saya disini bekerja sebagai developer untuk membantu partai ini berkembang</p>
            <div>
